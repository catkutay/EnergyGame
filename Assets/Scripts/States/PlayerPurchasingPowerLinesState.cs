...
public class PlayerPurchasingPowerLinesState : PlayerState
{
    ...
    public PlayerPurchasingPowerLinesState(GameController gameController, EnergySystemObjectController purchasingObjectController, Vector3 position, UIController uiController) : base(gameController)
    {
